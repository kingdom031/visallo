...
public interface WorkProductServiceHasElements<TVertex extends WorkProductVertex, TEdge extends WorkProductEdge> {
    ...
    GraphUpdateContext.UpdateFuture<Edge> addOrUpdateProductEdgeToAncillaryEntity(GraphUpdateContext ctx, String edgeId, Vertex productVertex, String entityId, UpdateProductEdgeOptions options, Visibility visibility);
}
